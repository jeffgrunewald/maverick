defmodule Maverick.Request.Util do
  ...
  def wrap_response({code, headers, response}, _, _)
      when is_integer(code) and is_binary(response) do
    {code, wrap_headers(headers), response}
  end

  def wrap_response({:ok, headers, response}, success, _) when is_binary(response) do
    {success, wrap_headers(headers), response}
  end
  ...
  def wrap_response({:ok, response}, success, _) when is_binary(response) do
    {success, [content_type()], response}
  end
  ...
  def wrap_response({:error, response}, _, error) when is_binary(response) do
    {error, [content_type()], response}
  end
  ...
  def wrap_response(response, success, _) when is_binary(response) do
    {success, [content_type()], response}
  end
